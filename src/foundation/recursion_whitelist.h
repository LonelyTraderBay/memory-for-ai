 ...
 *
 * Cypher recursive descent parser (bounded by query nesting depth ~5; UNION
 * chains bounded by CYPHER_MAX_PARSE_DEPTH via the parse_query_seeded depth
 * seed):
 *   - parse_or_expr, parse_xor_expr, parse_and_expr, parse_not_expr
 *   - parse_atom_expr, parse_post_where, cbm_parse, parse_query_seeded
 *
...
#define CBM_RECURSION_WHITELIST                                                                 \
    "parse_or_expr", "parse_xor_expr", "parse_and_expr", "parse_not_expr", "parse_atom_expr",   \
        "parse_post_where", "cbm_parse", "parse_query_seeded", "eval_expr", "glob_match",       \
