...
One self-contained native executable behind the wrapper. 162 languages via vendored tree-sitter grammars, refined by embedded Hybrid-LSP type resolution. 23 MCP tools. No Docker, no API key, no telemetry — everything runs locally.
