...
memory-for-ai interacts deeply with your filesystem. It reads source files across your entire codebase, writes to agent configuration files, and spawns background processes. This is inherent to what it does — not a bug.
...
metadata from
`https://api.github.com/repos/LonelyTraderBay/memory-for-ai/releases/latest`.
...
Explicit install, package-manager, and `memory-for-ai update` flows are
...
1. **Do NOT open a public issue, PR, or social-media post** for security
   vulnerabilities.
2. **Preferred:** use GitHub's [private vulnerability reporting](https://github.com/LonelyTraderBay/memory-for-ai/security/advisories/new)
...
[GitHub Security Advisory](https://github.com/LonelyTraderBay/memory-for-ai/security/advisories)
