...
| `test-release-artifact-contracts.sh` | Run release-selection, archive-extraction, and gate-chain source/artifact contracts without building a product binary. | `_test.yml` artifact-contracts |
